...
class ZSEmoticonInputView: UIView {

    @IBOutlet weak var collectionView: UICollectionView!
    
    @IBOutlet weak var bottomToolBarView: ZSEmoticonToolbar!
    
     /// 选中表情回调闭包属性
        private var selectedEmoticonCallBack: ((_ emoticon: CZEmoticon?)->())?
        
        /// 加载并且返回输入视图
    class func inputView(selectedEmoticon: @escaping (_ emoticon: CZEmoticon?)->()) -> ZSEmoticonInputView {
            
            let nib = UINib(nibName: "ZSEmoticonInputView", bundle: nil)
            
            let v = nib.instantiate(withOwner: nil, options: nil)[0] as! ZSEmoticonInputView
        ...
        override func awakeFromNib() {
            ...
            // 注册可重用 cell
            collectionView.register(ZSEmoticonCell.self, forCellWithReuseIdentifier: cellId)
...
//            pageControl.setValue(selectedImage, forKey: "_currentPageImage")
    ...
    extension ZSEmoticonInputView: ZSEmoticonToolbarDelegate {

        func emoticonToolbarDidSelectedItemIndex(toolbar: ZSEmoticonToolbar, index: Int) {
    ...
    extension ZSEmoticonInputView: UICollectionViewDelegate {
...
//             indexPath.section => 对应的就是分组
            bottomToolBarView.selectedIndex = target.section
...
//            pageControl.currentPage = target.item
    ...
    extension ZSEmoticonInputView: UICollectionViewDataSource {
        
        // 分组数量 - 返回表情包的数量
        func numberOfSections(in collectionView: UICollectionView) -> Int {
            
            print("numberOfSectinos-----\(CZEmoticonManager.shared.packages.count)")
        ...
        func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
            ...
            print("numberOfItemsInSection-----\(CZEmoticonManager.shared.packages[section].numberOfPages)")
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            // 1. 取 cell
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! ZSEmoticonCell
    ...
    extension ZSEmoticonInputView: CZEmoticonCellDelegate {

        /// 选中的表情回调
        ///
        /// - parameter cell: 分页 Cell
        /// - parameter em:   选中的表情，删除键为 nil
        func emoticonCellDidSelectedEmoticon(cell: ZSEmoticonCell, em: CZEmoticon?) {
            // print(em)
