...
@objc protocol ZSEmoticonToolbarDelegate: NSObjectProtocol {
...
class ZSEmoticonToolbar: UIView {
    
    /// 代理
       weak var delegate: ZSEmoticonToolbarDelegate?
    /// 选中分组索引
...
private extension ZSEmoticonToolbar{
    func setupUI(){
        //获取表情管理单利
